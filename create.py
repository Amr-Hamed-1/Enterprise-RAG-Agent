...
with open("06_generation_and_prompt_engineering.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook_content, f, ensure_ascii=False, indent=1)

print("🎉 تم إنشاء '06_generation_and_prompt_engineering.ipynb' بنجاح بكود الإنتاج الاحترافي!")